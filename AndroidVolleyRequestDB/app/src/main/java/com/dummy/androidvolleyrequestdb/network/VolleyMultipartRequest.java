...
public class VolleyMultipartRequest extends Request<NetworkResponse> {
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        try {
            ...
            if (data != null && data.size() > 0) {
                if(!data.containsKey(null)&&!data.containsKey("")) {
                    dataParse(dos, data);
                }
            }
            // close multipart form data after text and image data
     ...
     *
     * @param dataOutputStream data output stream handle image attachment
    ...
    /**
     * Write data image into header and data output stream.
     *
